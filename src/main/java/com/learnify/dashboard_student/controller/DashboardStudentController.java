package com.learnify.dashboard_student.controller;
...
import com.learnify.dashboard_student.DatabaseConnection;
...
public class DashboardStudentController {
    ...
    private void handleQuizIconClick() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/quiz/student_dashboard.fxml"));
            Parent root = loader.load();
            Stage stage = new Stage();
            stage.setTitle("Quiz Student");
