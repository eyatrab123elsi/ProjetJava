...
public class QuizApp extends Application {
    ...
    public void start(Stage stage) throws IOException {
        try {
             // Load the CSS file
             css = Objects.requireNonNull(getClass().getResource("/quiz/styles.css")).toExternalForm();

            Parent root = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("/quiz/login.fxml")));
